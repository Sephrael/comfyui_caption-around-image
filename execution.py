# LINES 490-493 ADDED FOR EXECUTION TIME TO WORK in caption_around_image node, have to modify in main ComfyUI folder...
...
## LINES ADDED FOR EXECUTION TIME TO WORK in caption_around_image node
