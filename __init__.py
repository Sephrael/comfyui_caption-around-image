...
from .debug_prompt_values import (
    NODE_CLASS_MAPPINGS as DEBUG_WIDGET_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as DEBUG_WIDGET_DISPLAY_NAME_MAPPINGS,
)
NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(CAI_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(DEBUG_WIDGET_CLASS_MAPPINGS)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(CAI_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(DEBUG_WIDGET_DISPLAY_NAME_MAPPINGS)
