...
from .print_prompt_values import (
    NODE_CLASS_MAPPINGS as PRINTPROMPT_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as PRINTPROMPT_DISPLAY_NAME_MAPPINGS,
)

from .template_textbox import (
    NODE_CLASS_MAPPINGS as INPUTTEMPLATE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as INPUTTEMPLATE_DISPLAY_NAME_MAPPINGS,
)

NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(CAI_NODE_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(PRINTPROMPT_CLASS_MAPPINGS)
NODE_CLASS_MAPPINGS.update(INPUTTEMPLATE_CLASS_MAPPINGS)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(CAI_NODE_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(PRINTPROMPT_DISPLAY_NAME_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(INPUTTEMPLATE_DISPLAY_NAME_MAPPINGS)
